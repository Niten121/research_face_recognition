...
heading_names = ['LBP Energy', 'LBP Entropy', 'Contrast', 'Dissimilarity', 'Homogeneity', 'Energy', 'Correlation', 'Gabor Energy', 'Gabor Entropy', 'name']
...
with open('ORL_mix_features.csv', "w", newline="") as wr:
